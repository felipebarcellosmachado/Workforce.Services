...
{
    public class QualificationService : CrudService<Domain.Infra.HumanResource.Qualification.Entity.Qualification>, IQualificationService
    {
        ...
        public async Task<IList<Domain.Infra.HumanResource.Qualification.Entity.Qualification>> GetAllByEnvironmentId(int environmentId)
        {
            try
            {
                ...
                var result = await response.Content.ReadFromJsonAsync<IList<Domain.Infra.HumanResource.Qualification.Entity.Qualification>>(_jsonOptions);
                ...
                return result ?? new List<Domain.Infra.HumanResource.Qualification.Entity.Qualification>();
            }
            catch (Exception ex)
            {
        ...
        public async Task<Domain.Infra.HumanResource.Qualification.Entity.Qualification> GetByEnvironmentIdAndId(int environmentId, int id)
        {
            try
            {
                ...
                if (response.StatusCode == System.Net.HttpStatusCode.NotFound)
                {
                    ...
                    return default(Domain.Infra.HumanResource.Qualification.Entity.Qualification)!;
                }
                    
                response.EnsureSuccessStatusCode();
                
                var result = await response.Content.ReadFromJsonAsync<Domain.Infra.HumanResource.Qualification.Entity.Qualification>(_jsonOptions);
