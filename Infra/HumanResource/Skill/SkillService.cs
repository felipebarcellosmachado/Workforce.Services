...
{
    public class SkillService : CrudService<Workforce.Domain.Infra.HumanResource.Skill.Entity.Skill>, ISkillService
    {
        ...
        public async Task<IList<Workforce.Domain.Infra.HumanResource.Skill.Entity.Skill>> GetAllByEnvironmentId(int environmentId)
        {
            try
            {
                ...
                var result = await response.Content.ReadFromJsonAsync<IList<Workforce.Domain.Infra.HumanResource.Skill.Entity.Skill>>(_jsonOptions);
                ...
                return result ?? new List<Workforce.Domain.Infra.HumanResource.Skill.Entity.Skill>();
            }
            catch (Exception ex)
            {
