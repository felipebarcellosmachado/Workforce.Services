...
namespace Workforce.Services.Core.HumanResourceManagement.Availability
{
    public class AvailabilityService : IAvailabilityService
    {
        ...
        public async Task<IList<Domain.Core.HumanResourceManagement.Availability.Entity.Availability>> GetAllByEnvironmentIdAsync(int environmentId, CancellationToken ct = default)
        {
            return await _httpClient.GetFromJsonAsync<IList<Domain.Core.HumanResourceManagement.Availability.Entity.Availability>>($"{BaseUrl}/all/environment/{environmentId}", ct) ?? new List<Domain.Core.HumanResourceManagement.Availability.Entity.Availability>();
        }
